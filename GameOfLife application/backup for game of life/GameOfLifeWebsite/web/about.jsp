...
<html>
    ...
    <body>
        <div id="main">
            ...
            <ul>
                <li>The main focus of this project is to test the validity of a new algorithm I created called AIA (Artificial Intelligence Algorithm) by testing:
                    <ol>
                        ...
                        <li>That AIA's score slowly increases over time to show that it learned.</li>
                    </ol>
                </li>
                <li>The results will tell whether AIA is faulty and needs reworked, or that AIA is ready for the next step.</li>
            ...
            <br />
            <br />
            <h1>Brief about AIA</h1>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AIA is a culmination of 3 years of research, and a step to hopefully a more human like AI (Artificial Intelligence).If AIA succeeds in this game, then it will be put into a custom environment that</p>
            <p> will hopefully create that AI.AIA can be described as having control over Nodes. It keeps all of the Nodes held up in something that could be analogous to a jar.</p>
            <p>When AIA receives an abstract unique state, it finds the Node that holds that state, or makes one if it cannot find it.If a new Node</p>
            ...
            <ul>
                <li>Thank you to
                    <ol>
                        ...
                        <li>everyone that will help train AIA before the website goes public.</li>
            ...
            <p>Here is the documentation for the algorithm AIA I built that is currently running the smart AI.</p>
            <a href="/GameOfLifeWebsite/javadoc/index.html" target="_blank">API documentation</a>
        </div>
    </body>
</html>
