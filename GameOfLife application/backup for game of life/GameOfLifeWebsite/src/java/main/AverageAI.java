...
public class AverageAI {
    ...
    public void setGame(AtomicReference<GameOfLifeAndDeathGame> current)
    {
        game = current;
    }
...
//                        calculateShowDifference();
                        ...
                        game.get().makeMove(((Point) move[1]).y, ((Point) move[1]).x, 2);
                        ...
                        game.get().makeMove(((Point) move[2]).y, ((Point) move[2]).x, 2);
                        ...
                        game.get().makeMove(((Point) move[3]).y, ((Point) move[3]).x, 2);
                    }
                    else
                    {
