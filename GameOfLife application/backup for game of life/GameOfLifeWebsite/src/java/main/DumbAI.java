...
public class DumbAI {
    ...
    public AtomicReference<GameOfLifeAndDeathGame> game;
            ...
            public void run()
            {
                ...
                if(value >= 0.67) //Take a random player cell.
                {
                    ...
                    if(!playerCells.isEmpty())
                        game.get().makeMove(playerCells.get(0).y, playerCells.get(0).x, 2);
                    else
                ...
                else if(value >= 0.34) //Take a random computer cell.
                {
                    ...
                    if(!currentCells.isEmpty())
                        game.get().makeMove(currentCells.get(0).y, currentCells.get(0).x, 2);
                    else
                        game.get().makeMove(0, 0, 2);
                }
                else //Add a random cell, and take 2 random ones away.
                {
                    if(currentCells.size() != 1)
                    {
                        ...
                        if(!openCells.isEmpty())
                            game.get().makeMove(openCells.get(0).y, openCells.get(0).x, 2);
                        else
                            game.get().makeMove(0, 0, 2);
                        ...
                        if(currentCells.size() != 1 && !currentCells.isEmpty())
                            game.get().makeMove(currentCells.get(1).y, currentCells.get(1).x, 2);
                        else
                        {
                            game.get().undoMove(2);
                            if(!currentCells.isEmpty())
    ...
    void setGame(AtomicReference<GameOfLifeAndDeathGame> current) 
    {
        game = current;
    }
}
